...
def run_comprehensive_fine_tuning_experiments(
    ...
    Args:
        pretrained_models: List of paths to pre-trained models
        appliance_cases: List of appliance detection cases
        fine_tune_configs: List of fine-tuning configuration dictionaries
...
def load_cer_case_data(case_name: str, dataset_type: str = "CER") -> Optional[tuple]:
    ...
    Args:
        case_name: Name of appliance case (e.g., 'cooker_case')
        dataset_type: Type of dataset ("CER" or "COMSTOCK")
    
    Returns:
        Tuple of training/validation/test data or None if loading fails
    """
